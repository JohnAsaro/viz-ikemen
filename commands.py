...
ACTIONS = ["None", "Triple Kung Fu Palm", "Smash Kung Fu Upper", "Kung Fu Blocking (Air/High)", "Kung Fu Blocking (Low)",
            ...
            "Crouching Light Punch", "Crouching Strong Punch", "Crouching Light Kick", "Crouching Strong Kick",
...
ACTIONS_ANJI = ["None", "Walk Forward", "Walk Back", "Jump", "Crouch", "Jump Forward", "Jump Back", "Down Forward", "Down Back"]